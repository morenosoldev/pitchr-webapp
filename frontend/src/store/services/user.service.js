...
function login(email, password) {
    return config.post("/login", {"email": email, "password": password}).then(({ data }) => {
...
function updateGoal(goal,percentage,id){
    return config.put(`/updateGoal/${id}`, {"goal": goal, "percentage": percentage})
}
...
function updateInvestmentPreference(preferences,id){
    return config.put(`/updateInvestmentPreference/${id}`, {"preferences": preferences})
}
