...
export function authentication(state = initialState, action) {
  ...
  switch (action.type) {
    ...
    case userConstants.UPDATE_CAPITAL_SUCCESS:
      return {
        ...state,
        user: { ...state.user, available_capital: action.capital },
      };
    ...
    case userConstants.UPDATE_INDUSTRY_SUCCESS:
      return { ...state, user: { ...state.user, industry: action.industry } };
    ...
    case userConstants.UPDATE_PROFILE_PICTURE_SUCCESS:
      return { ...state, user: { ...state.user, profile_pic: action.picture } };
    ...
    case userConstants.UPDATE_GOAL_SUCCESS:
      return {
        ...
        user: {
          ...
          percentage: action.goal.percentage,
        },
      };
    ...
    case userConstants.UPDATE_STAGE_SUCCESS:
      return {
        ...state,
        user: { ...state.user, development_stage: action.stage },
      };
    ...
    case userConstants.UPDATE_CALENDLY_SUCCESS:
      return { ...state, user: { ...state.user, calendly: action.calendly } };
