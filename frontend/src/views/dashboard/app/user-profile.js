                  ...
                  >
                    <div className="profile-img">
                      ...
                      <label className="add-picture" for="file-input-cover">
                        <i
                          class="upload-icon fas fa-camera"
                                  ...
                                  <Col sm>
                                    <div>
                                      ...
                                      >
                                        <h4>Industry</h4>
                                        {writeIndustry &&
                                        industrys.length > 0 ? null : (
                                          <i
                                            className="fas fa-user-edit"
                                            onClick={() =>
                                              setWriteIndustry(true)
                                            }
                                            style={{ cursor: "pointer" }}
                                          ></i>
                                        )}
                                      ...
                                      {writeIndustry ? (
                                        <div>
                                          <Form>
                                            ...
                                            >
                                              <Form.Label>
                                                What industrys are you looking
                                                for?
                                              </Form.Label>
                                    ...
                                    {writeCompetences ? (
                                      <div>
                                        <Form>
                                          ...
                                          >
                                            <Form.Label>
                                              What competences are you looking
                                              for?
                                            </Form.Label>
                                            <InputGroup className="mb-3">
                                              <FormControl
