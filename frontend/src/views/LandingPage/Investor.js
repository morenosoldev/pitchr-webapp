...
import pagePreview from './images/hero.png';
...
export default function Investor() {
    ...
    <div className="tw-relative tw-w-full tw-px-5 tw-px-8 tw-mx-auto tw-leading-7 tw-text-gray-900 tw-max-w-7xl lg:tw-px-16 xl:tw-px-32">
      <div className="tw-flex tw-flex-col tw-flex-wrap tw-items-center tw-text-left md:tw-flex-row">
        <div className="tw-flex-1 tw-opacity-100 xl:tw-pr-12 tw-transform-none">
          ...
          {/* Text */}
          <p className="tw-box-border tw-mt-0 tw-mb-8 tw-text-base tw-font-normal tw-text-center tw-text-gray-500 lg:tw-text-xl md:tw-text-left lg:tw-mb-8">Discover new investment opportunities, with up-front access to decks, video pitches, meeting scheduling and due diligence packs.</p>
          {/* Buttons */}
  ...
  <section ref={myRef} className="tw-relative tw-w-full tw-py-12 tw-overflow-hidden tw-bg-white md:tw-py-20 xl:tw-pt-32 xl:tw-pb-40">
    <div className="tw-container tw-relative tw-flex tw-flex-col tw-justify-between tw-h-full tw-max-w-6xl tw-px-10 tw-mx-auto xl:tw-px-0">
      <h2 className="tw-mb-1 tw-text-3xl tw-font-extrabold tw-leading-tight tw-text-gray-900 tw-text-4xl">Features</h2>
          ...
          <div className="tw-flex tw-flex-col tw-w-full tw-mb-10 sm:tw-flex-row">
              ...
              <div className="tw-relative tw-h-full tw-ml-0 tw-mr-0 sm:tw-mr-10">
                ...
                <div className="tw-relative tw-h-full tw-p-5 tw-bg-white tw-border-2 tw-rounded-lg tw-border-blue-600">
                  <div className="tw-flex tw-items-center tw--mt-1">
                    ...
                    <h3 className="tw-my-2 tw-ml-3 tw-text-lg tw-font-bold tw-text-gray-800">Comprehensive pitches</h3>
                  </div>
                  <p className="tw-mt-3 tw-mb-1 tw-text-xs tw-font-medium tw-text-indigo-500 tw-uppercase" />
                  <p className="tw-mb-2 tw-text-gray-600">Review comprehensive pitches asynchronously with up-front access to decks, video pitches and metrics.</p>
                </div>
              </div>
            </div>
            <div className="tw-w-full sm:tw-w-1/2">
              <div className="tw-relative tw-h-full tw-ml-0 md:tw-mr-10">
                ...
                <div className="tw-relative tw-h-full tw-p-5 tw-bg-white tw-border-2 tw-rounded-lg tw-border-blue-600">
                  <div className="tw-flex tw-items-center tw--mt-1">
                    <img className='investor-icon' src={scheduling}/>
                    <h3 className="tw-my-2 tw-ml-3 tw-text-lg tw-font-bold tw-text-gray-800">Meeting scheduling</h3>
                  </div>
                  <p className="tw-mt-3 tw-mb-1 tw-text-xs tw-font-medium tw-text-purple-500 tw-uppercase" />
                  <p className="tw-mb-2 tw-text-gray-600">Easily schedule meetings with founders using our Calendly integration.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="tw-flex tw-flex-col tw-w-full tw-mb-5 sm:tw-flex-row">
            <div className="tw-w-full tw-mb-10 sm:tw-mb-0 sm:tw-w-1/2">
              <div className="tw-relative tw-h-full tw-ml-0 tw-mr-0 sm:tw-mr-10">
                ...
                <div className="tw-relative tw-h-full tw-p-5 tw-bg-white tw-border-2 tw-rounded-lg tw-border-blue-600">
                  <div className="tw-flex tw-items-center tw--mt-1">
                    <img className='investor-icon' src={filtering}/>
                    <h3 className="tw-my-2 tw-ml-3 tw-text-lg tw-font-bold tw-text-gray-800">Personalized filtering</h3>
                  </div>
                  <p className="tw-mt-3 tw-mb-1 tw-text-xs tw-font-medium tw-text-blue-400 tw-uppercase" />
                  <p className="tw-mb-2 tw-text-gray-600">Focus your energy on opportunities that are worth your time, by personalizing and streamlining your feed by industry and location.</p>
                </div>
              </div>
            </div>
            <div className="tw-w-full sm:tw-w-1/2">
              <div className="tw-relative tw-h-full tw-ml-0 md:tw-mr-10">
                <span className="tw-absolute tw-top-0 tw-left-0 tw-w-full tw-h-full tw-mt-1 tw-ml-1 tw-bg-green-500 tw-rounded-lg tw-bg-blue-600" />
                <div className="tw-relative tw-h-full tw-p-5 tw-bg-white tw-border-2 tw-rounded-lg tw-border-blue-600">
                  <div className="tw-flex tw-items-center tw--mt-1">
                    <img className='investor-icon' src={simple}/>
                    <h3 className="tw-my-2 tw-ml-3 tw-text-lg tw-font-bold tw-text-gray-800">Simple due diligence</h3>
                  </div>
                  <p className="tw-mt-3 tw-mb-1 tw-text-xs tw-font-medium tw-text-green-500 tw-uppercase" />
                  <p className="tw-mb-2 tw-text-gray-600">Shorten your dealflow considerably, and request access to a startup's due diligence pack with the click of a button.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="tw-hidden tw-w-1/3 lg:tw-block">
          <div className="tw-absolute tw-w-full tw-max-w-4xl tw-pl-12 tw--mt-20 xl:tw--mt-32">
            ...
            <div className="tw-relative tw-overflow-hidden tw-border-2 tw-border-black tw-rounded-2xl">
              <img src={pagePreview} className="tw-object-cover tw-w-full tw-h-full tw-transform" />
            </div>
          </div>
        </div>
      </div>
