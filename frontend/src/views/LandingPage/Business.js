...
import sharable from './images/sharable.png';
import comprehensive from './images/comprehensive.png';
import '../../assets/scss/custom/landingpage/investor.scss'
...
export default function Business() {
    ...
    const scrollTo = () => {
        window.scrollTo({ behavior: 'smooth', top: myRef.current.offsetTop + 70})
      }
...
<div>
  ...
  {/* Section 4 */}
  <section ref={myRef}  className="tw-relative tw-w-full tw-py-12 tw-overflow-hidden tw-bg-white md:tw-py-20 xl:tw-pt-32 xl:tw-pb-40">
    <div className="tw-container tw-relative tw-flex tw-flex-col tw-justify-between tw-h-full tw-max-w-6xl tw-px-10 tw-mx-auto xl:tw-px-0">
      <h2 className="tw-mb-1 tw-font-extrabold tw-leading-tight tw-text-gray-900 tw-text-4xl">Features</h2>
      <p className="tw-mb-12 tw-text-lg tw-text-gray-500">Here is a few of the awesome features we provide - and even more are coming!</p>
      <div className="tw-flex tw-w-full tw-h-full">
        <div className="tw-w-full lg:tw-w-2/3">
          {/* Feature tw-blocks first column */}
          <div className="tw-flex tw-flex-col tw-w-full tw-mb-10 sm:tw-flex-row">
            <div className="tw-w-full tw-mb-10 sm:tw-mb-0 sm:tw-w-1/2">
              <div className="tw-relative tw-h-full tw-ml-0 tw-mr-0 sm:tw-mr-10">
                <span className="tw-absolute tw-top-0 tw-left-0 tw-w-full tw-h-full tw-mt-1 tw-ml-1 tw-rounded-lg tw-bg-blue-600" />
                <div className="tw-relative tw-h-full tw-p-5 tw-bg-white tw-border-2 tw-rounded-lg tw-border-blue-600">
                  <div className="tw-flex tw-items-center tw--mt-1">
                  <img className='investor-icon' src={comprehensive}/>

                    <h3 className="tw-my-2 tw-ml-3 tw-text-lg tw-font-bold tw-text-gray-800">Comprehensive Pitching</h3>
                  </div>
                  <p className="tw-mt-3 tw-mb-1 tw-text-xs tw-font-medium tw-text-indigo-500 tw-uppercase" />
                  <p className="tw-mb-2 tw-text-gray-600">Give investors the most comprehensive overview of your startup possible - asynchronously! Upload everything from your deck to your team's LinkedIn profiles.</p>
                </div>
              </div>
            </div>
            <div className="tw-w-full sm:tw-w-1/2">
              <div className="tw-relative tw-h-full tw-ml-0 md:tw-mr-10">
                <span className="tw-absolute tw-top-0 tw-left-0 tw-w-full tw-h-full tw-mt-1 tw-ml-1 tw-rounded-lg tw-bg-blue-600" />
                <div className="tw-relative tw-h-full tw-p-5 tw-bg-white tw-border-2 tw-rounded-lg tw-border-blue-600">
                  <div className="tw-flex tw-items-center tw--mt-1">
                  <img className='investor-icon' src={gauge}/>
                    <h3 className="tw-my-2 tw-ml-3 tw-text-lg tw-font-bold tw-text-gray-800">Gauge Investor Traction</h3>
                  </div>
                  <p className="tw-mt-3 tw-mb-1 tw-text-xs tw-font-medium tw-text-purple-500 tw-uppercase" />
                  <p className="tw-mb-2 tw-text-gray-600">Your interface will have personalized data overviews, so you can gauge the investor traction for your Pitchr fundraising profile, and determine if the timing for your raise is right.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <Modal.Footer>
          ...
          {/* Feature tw-blocks second column */}
          <div className="tw-flex tw-flex-col tw-w-full tw-mb-5 sm:tw-flex-row">
            <div className="tw-w-full tw-mb-10 sm:tw-mb-0 sm:tw-w-1/2">
              <div className="tw-relative tw-h-full tw-ml-0 tw-mr-0 sm:tw-mr-10">
                <span className="tw-absolute tw-top-0 tw-left-0 tw-w-full tw-h-full tw-mt-1 tw-ml-1 tw-rounded-lg tw-bg-blue-600" />
                <div className="tw-relative tw-h-full tw-p-5 tw-bg-white tw-border-2 tw-rounded-lg tw-border-blue-600">
                  <div className="tw-flex tw-items-center tw--mt-1">
                  <img className='investor-icon' src={pack}/>
                    <h3 className="tw-my-2 tw-ml-3 tw-text-lg tw-font-bold tw-text-gray-800">Due Diligence Pack</h3>
                  </div>
                  <p className="tw-mt-3 tw-mb-1 tw-text-xs tw-font-medium tw-text-blue-400 tw-uppercase" />
                  <p className="tw-mb-2 tw-text-gray-600">Organize your sensitive company information in the Pitchr document room. Investors can request access, if they are interested in doing diligence checks on your startup.</p>
                </div>
              </div>
            </div>
            <div className="tw-w-full sm:tw-w-1/2">
              <div className="tw-relative tw-h-full tw-ml-0 md:tw-mr-10">
                <span className="tw-absolute tw-top-0 tw-left-0 tw-w-full tw-h-full tw-mt-1 tw-ml-1 tw-rounded-lg tw-bg-blue-600" />
                <div className="tw-relative tw-h-full tw-p-5 tw-bg-white tw-border-2 tw-border-green-500 tw-rounded-lg tw-border-blue-600">
                  <div className="tw-flex tw-items-center tw--mt-1">
                  <img className='investor-icon' src={sharable}/>  
                    <h3 className="tw-my-2 tw-ml-3 tw-text-lg tw-font-bold tw-text-gray-800">Sharable profile  link</h3>
                  </div>
                  <p className="tw-mt-3 tw-mb-1 tw-text-xs tw-font-medium tw-text-green-500 tw-uppercase" />
                  <p className="tw-mb-2 tw-text-gray-600">Share your Pitchr profile link on all your socials, so investors have the best opportunity possible to scout your startup. Expand your reach beyond just Pitchr's investors.</p>
                </div>
              </div>
            </div>
          </div>
        </div>
        <div className="tw-hidden tw-w-1/3 lg:tw-block">
          <div className="tw-absolute tw-w-full tw-max-w-4xl tw-pl-12 tw--mt-20 xl:tw--mt-32">
            <div className="tw-absolute tw-top-0 tw-left-0 tw-w-full tw-h-full tw-mt-2 tw-ml-10 tw-bg-gray-900 tw-rounded-2xl" />
            <div className="tw-relative tw-overflow-hidden tw-border-2 tw-border-black tw-rounded-2xl">
              <img src={hero2} className="tw-object-cover tw-w-full tw-h-full tw-transform" />
            </div>
          </div>
        </div>
      </div>
    ...
    <div className="tw-px-8 tw-py-8 tw-mx-auto tw-max-w-7xl">
      <div className="tw-relative tw-px-6 tw-py-10 tw-overflow-hidden tw-rounded-2xl lg:tw-p-16 lg:tw-flex lg:tw-flex-col lg:tw-items-center lg:tw-justify-between">
        ...
        <div className="tw-absolute tw-bottom-0 tw-right-0 tw-z-10 tw-hidden tw-h-full tw-p-4 tw-mt-1 tw-ml-3 tw--mb-4 tw--mr-4 tw-transform tw-rotate-90 md:tw-block">
          <svg className="tw-w-auto tw-h-full tw-fill-current tw-text-blue-50" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 390 390"><defs /><g fillRule="nonzero"><circle cx={10} cy={10} r="9.5" className /><circle cx={47} cy={10} r="9.5" className /><circle cx={84} cy={10} r="9.5" /><circle cx={121} cy={10} r="9.5" /><circle cx={158} cy={10} r="9.5" className /><circle cx={195} cy={10} r="9.5" /><circle cx={232} cy={10} r="9.5" /><circle cx={269} cy={10} r="9.5" /><circle cx={306} cy={10} r="9.5" /><circle cx={343} cy={10} r="9.5" /><circle cx={380} cy={10} r="9.5" /><circle cx={47} cy={47} r="9.5" /><circle cx={84} cy={47} r="9.5" /><circle cx={121} cy={47} r="9.5" /><circle cx={158} cy={47} r="9.5" /><circle cx={195} cy={47} r="9.5" /><circle cx={232} cy={47} r="9.5" /><circle cx={269} cy={47} r="9.5" /><circle cx={306} cy={47} r="9.5" /><circle cx={343} cy={47} r="9.5" /><circle cx={380} cy={47} r="9.5" className /><circle cx={84} cy={84} r="9.5" /><circle cx={121} cy={84} r="9.5" className /><circle cx={158} cy={84} r="9.5" className /><circle cx={195} cy={84} r="9.5" /><circle cx={232} cy={84} r="9.5" /><circle cx={269} cy={84} r="9.5" /><circle cx={306} cy={84} r="9.5" /><circle cx={343} cy={84} r="9.5" /><circle cx={380} cy={84} r="9.5" className /><circle cx={121} cy={121} r="9.5" className /><circle cx={158} cy={121} r="9.5" className /><circle cx={195} cy={121} r="9.5" /><circle cx={232} cy={121} r="9.5" /><circle cx={269} cy={121} r="9.5" /><circle cx={306} cy={121} r="9.5" /><circle cx={343} cy={121} r="9.5" /><circle cx={380} cy={121} r="9.5" className /><circle cx={158} cy={158} r="9.5" className /><circle cx={195} cy={158} r="9.5" /><circle cx={232} cy={158} r="9.5" /><circle cx={269} cy={158} r="9.5" /><circle cx={306} cy={158} r="9.5" /><circle cx={343} cy={158} r="9.5" /><circle cx={380} cy={158} r="9.5" className /><circle cx={195} cy={195} r="9.5" /><circle cx={232} cy={195} r="9.5" /><circle cx={269} cy={195} r="9.5" /><circle cx={306} cy={195} r="9.5" /><circle cx={343} cy={195} r="9.5" /><circle cx={380} cy={195} r="9.5" className /><circle cx={232} cy={232} r="9.5" /><circle cx={269} cy={232} r="9.5" /><circle cx={306} cy={232} r="9.5" /><circle cx={343} cy={232} r="9.5" /><circle cx={380} cy={232} r="9.5" className /><circle cx={269} cy={269} r="9.5" /><circle cx={306} cy={269} r="9.5" className /><circle cx={343} cy={269} r="9.5" className /><circle cx={380} cy={269} r="9.5" /><circle cx={306} cy={306} r="9.5" /><circle cx={343} cy={306} r="9.5" /><circle cx={380} cy={306} r="9.5" /><circle cx={343} cy={343} r="9.5" /><circle cx={380} cy={343} r="9.5" /><circle cx={380} cy={380} r="9.5" /></g></svg>
        </div>
