    ...
    const uploadFile = async (file) => {
        ...
        await fileRef.put(file).on(
          ...
          () => {
            ...
            storage.ref(`files/${file.name}`).getDownloadURL()
              .then(
                (url) => {
                  // got download URL
...
<Row>
 ...
 <div style={{display:'flex',flexDirection:'column', alignItems:'center', justifyContent:'center',marginBottom:15}}>
            ...
            <p style={{marginTop:25}}>Drag and drop your presentation!</p>
             <span>Only PDF files is allowed, to see how to turn your PowerPoint into PDF <a href="#">Click here</a></span>
