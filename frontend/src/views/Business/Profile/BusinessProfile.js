...
//PASS ID TIL TEAM OG FILES, ÆNDR I DE OBJEKTER
                    ...
                    <Card>
                     <Card.Body className=" profile-page p-0">
                        <div className="profile-header" style={{display:'flex', justifyContent:'center'}}>
                           <div style={{marginTop:'1.25rem'}} className="user-detail text-center mb-3">
                             
                                 {profile?.profile_pic ? ( 
   <div className="profile-img">
   <img src={profile?.profile_pic} alt="profile-img1" className="avatar-130 img-fluid" />                                 
  ...
  <input id="file-input-cover" type="file" onChange={async(e) => await uploadImage(e.target.files[0])} style={{display:'none'}}/>
            ...
            <Tab.Container activeKey={key} onSelect={k => setKey(k)} id="left-tabs-example" defaultActiveKey="about-us">       
            <Card>
                <Card.Body>
            <div className="user-tabing">
                           ...
                           <Nav as="ul" variant="pills" className="d-flex align-items-center justify-content-center profile-feed-items p-0 m-0">
                              ...
                              <Nav.Item as="li" className="col-12 col-sm-2 p-0">
                                 <Nav.Link href="#about-us" eventKey="about-us" role="button" className="text-center p-3">About us</Nav.Link>
                              </Nav.Item>
                              
                              <Nav.Item as="li" className="col-12 col-sm-2 p-0">
                                 <Nav.Link href="#pitch" eventKey="pitch" role="button" className="text-center p-3">Pitch</Nav.Link>
                              </Nav.Item>

                              <Nav.Item as="li" className=" col-12 col-sm-2 p-0">
                                 <Nav.Link  href="#business-team"  eventKey="team" role="button" className="text-center p-3">Team</Nav.Link>
                              </Nav.Item>

                              <Nav.Item as="li" className=" col-12 col-sm-2 p-0">
                                 <Nav.Link  href="#financials"  eventKey="financials" role="button" className="text-center p-3">Financials</Nav.Link>
                              </Nav.Item>

                              <Nav.Item as="li" className="col-12 col-sm-2 p-0">
                                 <Nav.Link  href="#business-files"  eventKey="files" role="button" className="text-center p-3">Files</Nav.Link>
                              </Nav.Item>
                           </Nav>
                  </div> 
            </Card.Body>
...
<div style={{display:'flex',justifyContent:'center',padding:50}}>
   ...
   <>
{pitch ? (
                       <PitchDeck pitchID={pitch.id} pitchDeck={pitch.pitchDeck} loom={pitch.loom} calendly={pitch.calendly} businessID={pitch.BusinessId} userID={pitch.user_id} company={pitch.companyName} logo={pitch.companyLogo} undertitle={pitch.title} description={pitch.description} thumbnail={pitch.thumbnail} videoSrc={pitch.videoUrl}/>
                       ):
                                   (
                        <Container>
                           <Row>
                              <Col sm={12}> 
                                 ...
                                 <i style={{fontSize:'4rem',marginTop:20,marginBottom:20}} class="fas fa-times-circle"></i>
                                 {user?.user_id == id ? (
     <h3>Upload your first pitch! <Link to="/business/app/upload">Click Here.</Link></h3>
                                                ):(
                                                   null
                                                )}
                                   </div>
