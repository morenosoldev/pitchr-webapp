                ...
                <div className="right-sidebar-panel p-0">
                    <Card className="shadow-none">
                        <Card.Body className="p-0">
                            <div className="media-height p-3" data-scrollbar="init">
                                <div className="d-flex align-items-center mb-4">
                                    <div className="iq-profile-avatar status-online">
                                        <Image className="rounded-circle avatar-50" src={user1} alt=""/>
                                    </div>
                                    <div className="ms-3">
                                ...
                                <div className="d-flex align-items-center mb-4">
                                    <div className="iq-profile-avatar status-online">
                                        <Image className="rounded-circle avatar-50" src={user2} alt=""/>
                                    </div>
                                    <div className="ms-3">
                                ...
                                <div className="d-flex align-items-center mb-4">
                                    <div className="iq-profile-avatar status-online">
                                        <Image className="rounded-circle avatar-50" src={user3} alt=""/>
                                    </div>
                                    <div className="ms-3">
                                ...
                                <div className="d-flex align-items-center mb-4">
                                    <div className="iq-profile-avatar status-online">
                                        <Image className="rounded-circle avatar-50" src={user4} alt=""/>
                                    </div>
                                    <div className="ms-3">
                                ...
                                <div className="d-flex align-items-center mb-4">
                                    <div className="iq-profile-avatar status-online">
                                        <Image className="rounded-circle avatar-50" src={user5} alt=""/>
                                    </div>
                                    <div className="ms-3">
                                ...
                                <div className="d-flex align-items-center mb-4">
                                    <div className="iq-profile-avatar status-away">
                                        <Image className="rounded-circle avatar-50" src={user6} alt=""/>
                                    </div>
                                    <div className="ms-3">
                            ...
                            <div className="right-sidebar-toggle bg-primary text-white mt-3" onClick={minirightsidebar}>
