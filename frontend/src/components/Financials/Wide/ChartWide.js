      ...
      >
        ...
        <Dropdown>
          ...
          <Dropdown.Menu as={CustomMenu}>
            {user?.user_id == id ? (
              <Dropdown.Item onClick={() => deleteMetric()} eventKey="1">
                <BsTrash style={{ display: "inline" }} /> Delete
              </Dropdown.Item>
            ) : null}
            <Dropdown.Item onClick={handleShow} eventKey="2">
              <BsFillAspectRatioFill style={{ display: "inline" }} /> Showcase
            </Dropdown.Item>
          </Dropdown.Menu>
        </Dropdown>
      </div>
