...
import Explore from '../views/Business/Explore/Explore';
        ...
        <TransitionGroup style={{height:'100%'}}>
            <CSSTransition classNames="fadeUp" timeout={300}>
                <Switch>
                    ...
                    <Route path="/business/app/explore"                  component={Explore} />
                    ...
                    <Route path="/business/financials/upload/burnrate"      component={UploadBURN} />
                    ...
                    <Route path="/business/financials/insert/burnrate"      component={CreateBURN} />
